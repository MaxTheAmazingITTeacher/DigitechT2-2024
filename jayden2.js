...
for (let i = 0; i < numberOfMeteors; i++) {
    const meteorX = Math.random() * -2. - 2;
    const meteorY = Math.random() * -2. - 2;
    const meteorSpeed = Math.random() * 3 + 1;
...
setTimeout(() => {
    ...
    window.location.href = "file:///C:/Users/jayden.brooke/Downloads/DigitechT2-2024-main/DigitechT2-2024-main/lachlan_room001.html";
}, 30000);
...
function handleMeteors() {
    ...
    for (let i = 0; i < meteors.length; i++) {
        ...
        var factor = meteor.y / 100
        var width = factor * 18
        var height = factor * 26
        // Draw the meteor on the canvas
        ctx.drawImage(meteorImage, meteor.x, meteor.y, width, height);
...
function gameOver() {
    ...
    setTimeout(() => {
        // Redirect to another URL
        window.location.href = "file:///C:/Users/jayden.brooke/Downloads/DigitechT2-2024-main/DigitechT2-2024-main/jayden_room001.html";
    }, 5000);
}
